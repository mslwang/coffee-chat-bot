...
# ## Send message to user about match
# @client.command(pass_context=True)
# ## need to take matching result user IDs as input?  
# async def dm_user(ctx):
#     user = await client.get_user_info("User's ID here")
#     await client.send_message(user, "You have been matched with...")



# ## Writing data (user_id and roles) to JSON File

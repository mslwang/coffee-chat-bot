...
class Admin(commands.Cog):
    ...
    async def categories(self, ctx, *args):
        ...
        try:
            ...
            cats_msg_content, emotes_lst = await asyncio.gather(
            ...
            event_msg = await self.channel.send(embed=embed_msg)

            # event reactions
            # await asyncio.gather(self.event_reactions(event_msg, emotes_lst))
